	...
	$("body").on("click",function(){
			$(".all").attr("preload","auto");
			$(".changzhou").attr("preload","auto");
			$(".huaian").attr("preload","auto");
			$(".nanjing").attr("preload","auto");
			$(".nantong").attr("preload","auto");
			$(".suzhou").attr("preload","auto");
			$(".yancheng").attr("preload","auto");
			$(".zhenjiang").attr("preload","auto");
			$(".yanzhou").attr("preload","auto");
			$(".wuxi").attr("preload","auto");
			$(".taizhou").attr("preload","auto");
			$(".suqian").attr("preload","auto");
			$(".xuzhou").attr("preload","auto");
			$(".lianyungan").attr("preload","auto");
		}).click();
